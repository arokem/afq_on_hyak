...
with pydra.Submitter(plugin="slurm",
                     sbatch_args=f"-J pyafq -p gpu-a40 -A escience --mem=58G --time=10:00:00 -o /gscratch/escience/arokem/logs/pyafq.out -e /gscratch/escience/arokem/logs/pyafq.err --mail-user=arokem@uw.edu --mail-type=ALL") as sub:
    sub(runnable=t)
